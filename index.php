...
<body>
    ...
    <div class="card">
        ...
        <div class="container">
            ...
            <div style="max-width: 100%;" class="fill">
                <input type="text" id="lattitude"   placeholder="Lattitude" value="8.34661">
                <input type="text" id="longtitude"  placeholder="Longtitude" value="99.98064">
